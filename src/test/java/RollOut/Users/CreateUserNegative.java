...
public class CreateUserNegative extends RollOutUsers {
    ...
    public void createNewUserAndCheckVisible() throws IOException, InterruptedException {
        ...
        //Проверка на спецсимволы в имени, запрещены
        ...
        // Проверка на спецсимволы в локальной части, запрещены вначале в локальной части
        ...
        createUser("User" + count, "gmail@com" + count, "+79212312312331321423154131"); //более 15 симв
        //createUserNegative("User" + count, null, "79212312312331321423154131"); //более 15 симв, баг
        createUser("User" + count, "gmail@com" + count, "qqqq123"); //буквы
        createUser("User" + count, "gmail@com" + count, "+ERDFS+123"); //буквы и + вначале
        createUser("User" + count, "gmail@com" + count, "+7(123)456-78-90"); // маска и + вначале
        createUser("User" + count, "gmail@com" + count, "   +712132123456789 "); //20 симв с пробелами


        /** Проверка Описания негативные*/
        createUserNegativeChechAboutField("User" + count, "gmail@com" + count, "+71234", RandomStr.getStr(129)); // 129 симв
        createUserNegativeChechAboutField("User" + count, "gmail@com" + count, "+71234", RandomStr.getStr(500)); // 129 симв
    }
